...
wb1 = xlrd.open_workbook('primerjava_etalon_iz_serije_no3.xlsx')
wb2 = xlrd.open_workbook('Napak_1_kos_pretisnjen_3600rpm.xlsx')
...
Ftf_in =fre/2*(1+(Bd/Pd*np.cos(np.deg2rad(theta))))
...
#primer za analizo balansirnaja s integriranjem
...
print('vel napaka rms = ',rms_napaka_acc)
print('vel etalon rms = ',rms_etalon_acc)
